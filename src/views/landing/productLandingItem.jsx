...
export const ProductLandingItem = (props) => {
    const reverseClass = props.reverse ? '-order-1' : 'order-1'
    return(
        <div className='grid grid-cols-2 gap-14 m-24 items-center' >
            <div className={reverseClass}>
                <img className='w-84' src={props.imgSource} alt={props.title}/>
            </div>
            <div>   
                <h3>{props.title}</h3>
                <p>
